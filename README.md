# Mica Exporter for AWS Lambda

The Rust code is an experimental package to extract procrate file on AWS lambda. It is subject to change and intended only for evaluation purposes.
